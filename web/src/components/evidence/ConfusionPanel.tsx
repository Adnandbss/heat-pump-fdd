...
export function ConfusionPanel() {
  ...
  return (
    <GlassCard className="p-6" data-testid="confusion-heatmap">
      <div className="flex flex-wrap items-start justify-between gap-3 mb-4">
        <div>
          <h2 className="text-lg font-semibold">Confusion matrix</h2>
          <p className="text-xs text-white/45 mt-1">Same model family, two worlds. Values are written in each cell.</p>
        </div>
